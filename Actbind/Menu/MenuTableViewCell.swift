...
final class MenuTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var sinngatakoronauirusunituiteText: UILabel!
    @IBOutlet weak var sinngatakoronauirusunituiteImage: UIImageView!
    ...
    private func updateUI() {
        sinngatakoronauirusunituiteText.text = menu.text1
        sinngatakoronauirusunituiteImage.image = UIImage(named: menu.image1)
        ...
        if let userDefaults = userDefaults {
            ...
            if appColor == "Original" {
                ...
                activityImage.image = UIImage(named: menu.image3 + appColor!)
            }
        }
        houkokuText.text = menu.text4
        houkokuImage.image = UIImage(named: menu.image4)
        decorationTextLabel.text = menu.text5
        decorationImage.image = UIImage(named: menu.image5)
