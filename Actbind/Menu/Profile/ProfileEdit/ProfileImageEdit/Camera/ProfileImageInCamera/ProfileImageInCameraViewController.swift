//
//  ProfileImageInCameraViewController.swift
//  Actbind
//
...
final class ProfileImageInCameraViewController: UIViewController {
    ...
    @IBAction func toOutCameraButtonTouchUpInside(_ sender: Any) {
        ...
        performSegue(withIdentifier: "toProfileImageBackCameraView", sender: nil)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toProfileImageEditView" {
            let nextView = segue.destination as! ProfileImageEditViewController

            nextView.profileimage = resultImage
        }
    }
}

extension ProfileImageInCameraViewController: AVCapturePhotoCaptureDelegate {
    ...
    func photoOutput(_ output: AVCapturePhotoOutput, didFinishProcessingPhoto photo: AVCapturePhoto, error: Error?) {
        if let imageData = photo.fileDataRepresentation() {
            ...
            // 撮影結果画面へ遷移
            performSegue(withIdentifier: "toProfileImageEditView", sender: nil)
        }
    }
}
...
extension ProfileImageInCameraViewController {
    // カメラの画質の設定
