//
//  ProfileImageOutCameraViewController.swift
//  Actbind
//
...
final class ProfileImageOutCameraViewController: UIViewController {
    ...
    @IBAction func toInCameraButtonTouchUpInside(_ sender: Any) {
        changeButton.backgroundColor = UIColor.clear
...
extension ProfileImageOutCameraViewController: AVCapturePhotoCaptureDelegate {
...
extension ProfileImageOutCameraViewController {
    // カメラの画質の設定
