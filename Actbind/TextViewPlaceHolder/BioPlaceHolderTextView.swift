//
//  BioPlaceHolderTextView.swift
//  Actbind
//
//  Created by 柿本　海斗 on 2020/12/20.
//

import UIKit

final class BioPlaceHolderTextView: UITextView {
    ...
    @IBInspectable private var placeHolder: String = "" {
        willSet {
            if let userDefaults = userDefaults {
                ...
                if bio == "" {
                    placeHolderLabel.text = NSLocalizedString("jikosyoukaiwonyuuryoku", comment: "") // newValue
                } else {
